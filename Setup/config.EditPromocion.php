		...
		<div class="row">
			...
			<div class="col-md-8 thumbnail">
				...
				<form enctype="multipart/form-data" action="../functions/RegeditPromocion.php" method="POST">
					...
					<h4> Tipo </h4>
					<br>
					<select class="form-control" name="selectContenido" id="selectContenido">
					<option value="<?php echo $row['TIPO_ADVANCEMENT']; ?>"><?php echo $row['TIPO_ADVANCEMENT']; ?></option>
					<?php
						$result2 = obtenerTiposPromociones();
						while ($row2 = $result2->fetch_array(MYSQLI_ASSOC)){
						?>
							<option value="<?php echo $row2['NAMETYPE']; ?>"><?php echo $row2['NAMETYPE']; ?></option>
						<?php
						}
					?>
					</select>
